...
\begin{document}
  ...
  \input{./kapitel/00_00_abstract.tex}
  ...
  \chapter{Bestätigung}
  \input{./kapitel/02_00_bestaetigung.tex}
  
  \chapter{Vorwort des Authors}
  \input{./kapitel/03_00_vorwort.tex}
  
  \chapter{Einleitung}
  \pagenumbering{arabic}
  \input{./kapitel/04_00_einleitung.tex}  
  
  \chapter{Theoretische Grundlagen Projektmanagement}\label{chap:theorie_teil}
  \input{./kapitel/05_00_theoretischer_teil.tex}
  
  \chapter{Analyse IST-Zustand allink}\label{chap:analyse}
  \input{./kapitel/06_00_analyse.tex}
  
  \chapter{Branchenvergleich}\label{chap:branchenvergleich}
  \input{./kapitel/07_00_branchenvergleich.tex}
  
  \chapter{Anforderungsanalyse}\label{chap:anforderungen}
  \input{./kapitel/08_00_anforderungen.tex}
  
  \chapter{Lösungsansatz}\label{chap:loesungsansatz}
  \input{./kapitel/09_00_loesungsansatz.tex}
  
  \chapter{Proof of Concept}\label{chap:proof_of_concept}
  \input{./kapitel/10_00_proof_of_concept.tex}
  
  \chapter{Reflexion des Authors}\label{chap:reflektion}
  \input{./kapitel/11_00_reflektion.tex}
  
  \appendix
  
  \chapter{Rahmenbedingungen}
  \input{./kapitel/92_rahmenbedingungen.tex}
  
  \chapter{Aufgabenstellung}\label{chap:aufgabenstellung}
  \input{./kapitel/93_aufgabenstellung.tex}
  
  \input{./kapitel/94_projektplanung.tex}
