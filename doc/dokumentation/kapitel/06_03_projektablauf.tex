...
eine Anfrage oder eine Akquisition, der spricht sich mit den anderen Partnern ab 
und nimmt dann die Mitarbeiter mit in das Projekt, die er für nötig erachtet.
Dies kommt einem Projektmanamgement organisiert über die Linie aus der Theorie
am nächsten.

Der Projektablauf wird in drei Prozesse unterteilt: Die Projektannahme und Offertenerstellung,
die Projektdurchführung und der Projektabschluss. Dazu werden nun die 
Ablaufdiagramme erstellt. Darin wird jede Aktion mit einer eindeutigen Nummer versehen,
um später darauf im beschreibenden Text verweisen zu können. Nach einer Entscheidung erhöht
...
Es werden nicht immer alle erwähnten Tools in demselben Projekt eingesetzt,
...
Eine Projektanfrage endet entweder mit einer Absage oder mit dem Start eines neuen 
...
Sollte das Projekt angenommen werden, wird auf Grund der zu erbringenden
...
der Projektleiter bzw. Partner wieder neue Arbeitspakete zusammen und der
Bearbeitungsprozess beginnt von neuem (\textbf{5.2}). Wenn es sich bei den Wünschen
des Auftraggebers um neue und noch nicht bekannte Anforderungen handelt, überprüft
